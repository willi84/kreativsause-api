...
describe('analyzeWorkshopPage()', () => {
    ...
    it('should return workshop details', () => {
        ...
        const EXPECTED = {
            sections: [ 'date', 'time', 'event_category', 'event_tags', 'click_to_register' ],
            warnings: [],
    ...
    description: [ 'Mit dem Zukunftszentrum Brandenburg Ideen für nachhaltiges Verhalten entwickeln',
    ...
    links: [{href: 'https://www.zukunftszentrum-brandenburg.de/',
       text: 'www.zukunftszentrum-brandenburg.de' }]
  };
        const result = FN(html as string, { id: 'sample', title: 'sampleTitle', href: 'https://flaeminger.kreativsause.de/programm-2026/sample/' });
